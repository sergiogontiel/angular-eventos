...
export class ProductDetailComponent implements OnInit {
  producto: IProducto;
  constructor(private ruta: ActivatedRoute, private servicios: ProductService, private enrutador: Router) { }

  ngOnInit(): void {
    const id:number=this.ruta.snapshot.params.id;
    this.servicios.getProducto(id).subscribe(respServ => this.producto=respServ.producto)
  }
